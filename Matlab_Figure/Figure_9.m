...
% % legend('boxoff')
annotation('textbox',[0.66,0.87,0,0],'string','start of draw-down','Edgecolor','none','FontSize',8,'FontName', 'Times New Roman');
annotation('textbox',[0.64,0.85,0,0],'string','\leftarrow ','Edgecolor','none','FontSize',8,'FontName', 'Times New Roman');
box on
grid on 
