...
hl30 = load('./Data/Sediments_transport/hl230.txt');
hl20 = load('./Data/Sediments_transport/hl220.txt');
hl10 = load('./Data/Sediments_transport/hl210.txt');
hl30 = hl30(span2);
hl20 = hl20(span2);
hl10 = hl10(span2);
...
set(gca,'XTickLabel',[]);
annotation('textbox',[0.62,0.93,0,0],'string','start of draw-down','Edgecolor','none','FontSize',8,'FontName', 'Times New Roman');
annotation('textbox',[0.60,0.91,0,0],'string','\leftarrow ','Edgecolor','none','FontSize',8,'FontName', 'Times New Roman');
...
print('./Figures/fig12','-depsc','-r600')
