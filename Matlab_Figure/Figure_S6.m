...
clc;clear;
%% Load all the data
depth10=load('./Data/Tsunami_results/ndepth2_1.txt');
depth20=load('./Data/Tsunami_results/ndepth2_4.txt');
depth30=load('./Data/Tsunami_results/ndepth2_7.txt');


gradient1_h_10=load('./Data/Tsunami_results/ngradient2_0.txt');
gradient1_h_20=load('./Data/Tsunami_results/ngradient2_3.txt');
gradient1_h_30=load('./Data/Tsunami_results/ngradient2_6.txt');
gradient1_l_10=load('./Data/Tsunami_results/ngradient2_2.txt');
gradient1_l_20=load('./Data/Tsunami_results/ngradient2_5.txt');
gradient1_l_30=load('./Data/Tsunami_results/ngradient2_8.txt');
gradient1_m_10=load('./Data/Tsunami_results/ngradient2_1.txt');
gradient1_m_20=load('./Data/Tsunami_results/ngradient2_4.txt');
gradient1_m_30=load('./Data/Tsunami_results/ngradient2_7.txt');
start = 0;
time1=(load('./Data/Tsunami_results/ntime2_1.txt')+start)/3600;
...
print('./Figures/figS6','-depsc','-r600')
