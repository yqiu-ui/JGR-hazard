...
clc;clear;
%% Load all the data
depth10=load('./Data/Tsunami_results/ndepth1_1.txt');
depth20=load('./Data/Tsunami_results/ndepth1_4.txt');
depth30=load('./Data/Tsunami_results/ndepth1_7.txt');


gradient1_h_10=load('./Data/Tsunami_results/ngradient1_0.txt');
gradient1_h_20=load('./Data/Tsunami_results/ngradient1_3.txt');
gradient1_h_30=load('./Data/Tsunami_results/ngradient1_6.txt');
gradient1_l_10=load('./Data/Tsunami_results/ngradient1_2.txt');
gradient1_l_20=load('./Data/Tsunami_results/ngradient1_5.txt');
gradient1_l_30=load('./Data/Tsunami_results/ngradient1_8.txt');
gradient1_m_10=load('./Data/Tsunami_results/ngradient1_1.txt');
gradient1_m_20=load('./Data/Tsunami_results/ngradient1_4.txt');
gradient1_m_30=load('./Data/Tsunami_results/ngradient1_7.txt');
start = 0;
time1=(load('./Data/Tsunami_results/ntime1_1.txt')+start)/3600;
...
R = [linspace(0, 1, 128), linspace(1, 1, 128)]';
G = [linspace(0, 1, 128), linspace(1, 0, 128)]';
B = [linspace(1, 1, 128), linspace(1, 0, 128)]';
custom_map = [R, G, B];
...
print('./Figures/figS5','-depsc','-r600')
